...
public class GameSounds {
    ...
    public static void playLoop(String filename)
    {
        try
        {
            ...
            clip.open(AudioSystem.getAudioInputStream(TankGame.class.getResource(filename)));
    ...
    public static void play(final String filename)
    {
        try {
            ...
            new Thread() {
                public void run() {
                    try {
                        AudioInputStream in= AudioSystem.getAudioInputStream(TankGame.class.getResource(filename));
